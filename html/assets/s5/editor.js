var makeDoc = {
	...
	markupSet:  [
		...
		{name:'Link', key:'L', openWith:'\[', closeWith:'\](...url...)', placeHolder:'...linked text here...' },
		...
		{name: 'List', openWith: '\n\\list bulleted incremental\n\n', placeHolder: 'bullet', closeWith: '\n\n/link\n'},
		{name:'List (bullet)', key:'8', openWith:'\n\n*', closeWith:'\n'},
